...
abstract class Task implements ActiveRecordInterface
{
    ...
    public function setUsername($v)
    {
        ...
        if ($this->username !== $v) {
            $this->username = $v;
            $this->modifiedColumns[TaskTableMap::COL_USERNAME] = true;
        }
    ...
    public function setEmail($v)
    {
        ...
        if ($this->email !== $v) {
            $this->email = $v;
            $this->modifiedColumns[TaskTableMap::COL_EMAIL] = true;
        }
    ...
    public function setContent($v)
    {
        ...
        if ($this->content !== $v) {
            $this->content = $v;
            $this->modifiedColumns[TaskTableMap::COL_CONTENT] = true;
        }
    ...
    public function setEdited($v)
    {
        ...
        if ($this->edited !== $v) {
            $this->edited = $v;
            $this->modifiedColumns[TaskTableMap::COL_EDITED] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : TaskTableMap::translateFieldName('Username', TableMap::TYPE_PHPNAME, $indexType)];
            $this->username = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : TaskTableMap::translateFieldName('Email', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : TaskTableMap::translateFieldName('Edited', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(TaskTableMap::COL_USERNAME)) {
            $modifiedColumns[':p' . $index++]  = 'username';
        }
        if ($this->isColumnModified(TaskTableMap::COL_EMAIL)) {
        ...
        if ($this->isColumnModified(TaskTableMap::COL_EDITED)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TaskTableMap::COL_USERNAME)) {
            $criteria->add(TaskTableMap::COL_USERNAME, $this->username);
        }
        if ($this->isColumnModified(TaskTableMap::COL_EMAIL)) {
            $criteria->add(TaskTableMap::COL_EMAIL, $this->email);
        }
        if ($this->isColumnModified(TaskTableMap::COL_CONTENT)) {
        ...
        if ($this->isColumnModified(TaskTableMap::COL_EDITED)) {
            $criteria->add(TaskTableMap::COL_EDITED, $this->edited);
        }
    ...
    static public function loadValidatorMetadata(ClassMetadata $metadata)
    {
        ...
        $metadata->addPropertyConstraint('content', new Length(array ('max' => 500,)));
    }
